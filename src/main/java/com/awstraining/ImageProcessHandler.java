...
public class ImageProcessHandler implements RequestHandler<Map<String, Object>, APIGatewayProxyResponseEvent> {
  ...
  private static final String SNS_QUEUE_NAME = "task8-uploads-notification-queue";
  private static final String TOPIC_ARN = "arn:aws:sns:us-east-1:070176016091:task8-uploads-notification-topic";
